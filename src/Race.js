...
export const Race = () => {
  ...
  const isThereTwoRacersSet = () => {
    let racerCount = 0;
    if (pup.position === "lane1Set") {
      racerCount += 1;
    }
    if (dan.position === "lane2Set") {
      racerCount += 1;
    }
    if (honey.position === "lane3Set") {
      racerCount += 1;
    }
    if (golden.position === "lane4Set") {
      racerCount += 1;
    }
    if (foxy.position === "lane5Set") {
      racerCount += 1;
    }
    return racerCount > 1;
  };
    ...
    if (go === "MARK") {
      ...
      if (viewWidth <= 640) {
        document
          ...
          .style.setProperty("--tracking", viewWidth - 1270 + "px");
      } else if (viewWidth < 1400) {
        document
          .querySelector("#follow")
          .style.setProperty("--tracking", viewWidth - 1448 + "px");
      }
      const markSet = setTimeout(() => setGo("SET"), 1300);
  ...
  const raceResults = () => {
    ...
    let rounder = (num) => {
      return Math.round(num * 8) / 10;
    };
    let lane1 = [
      "pup",
      rounder(lane1Time.time),
      pup.sponsor,
      pup.id,
      pup.color,
    ];
    ...
    let lane5 = [
      "foxy",
      rounder(lane5Time.time),
      foxy.sponsor,
      foxy.id,
      foxy.color,
    ];
    let firstLast = [
      ["No Racers", 11, "No Sponsor", {}],
      ["No Racers", 3, "No Sponsor", {}],
    ];
    const result = (lane, fastSlow) => {
      if (lane[1] > fastSlow[1][1]) {
        fastSlow.splice(1, 1, lane);
      }
      lane[1] < fastSlow[0][1]
        ? fastSlow.splice(0, 1, lane)
        : lane[1] === fastSlow[0][1]
        ? fastSlow.splice(0, 0, lane)
        : (lane = ["No Record", null, ""]);
      return fastSlow;
    };
    [lane1, lane2, lane3, lane4, lane5].forEach((e) => {
      if (e[1] !== 0) {
        let tempRes = result(e, firstLast);
        return (firstLast = tempRes);
      }
    });
    return firstLast;
  };
  ...
  const the2ndWinner = () => {
    return raceResultsFinished.length > 2 ? raceResultsFinished[1][0] : null;
  };
  const the2ndWinnerObj = () => {
    return raceResultsFinished.length > 2 ? raceResultsFinished[1][3] : null;
  };
  const the2ndWinnerColor = () => {
    return raceResultsFinished.length > 2 ? raceResultsFinished[1][4] : null;
  };
  const the2ndWinnerText = () => {
    return raceResultsFinished.length > 2 ? raceResultsFinished[1][2] : null;
  };
  const the3rdWinner = () => {
    return raceResultsFinished.length > 3 ? raceResultsFinished[2][0] : null;
  };
  const the3rdWinnerObj = () => {
    return raceResultsFinished.length > 3 ? raceResultsFinished[2][3] : null;
  };
  const the3rdWinnerColor = () => {
    return raceResultsFinished.length > 3 ? raceResultsFinished[2][4] : null;
  };
  const the3rdWinnerText = () => {
    return raceResultsFinished.length > 3 ? raceResultsFinished[2][2] : null;
  };
  const theWinner = () => {
    return raceResultsFinished[0][0];
  };
  const theWinnerObj = () => {
    return raceResultsFinished[0][3];
  };
  const theWinnerColor = () => {
    return raceResultsFinished[0][4];
  };
  const theWinnerText = () => {
    return raceResultsFinished[0][2];
  };
  const winTitle = () => {
    return raceResultsFinished.length > 3 ? (
      "3 WAY TIE!!!"
    ) : raceResultsFinished.length > 2 ? (
      "TIE!!!"
    ) : (
      <font style={{ color: theWinnerColor() }}>WINNER!!!</font>
    );
  };
  ...
  useEffect(() => {
    if (go === "SET") {
      const markSetGo = setTimeout(() => {
        setGo("GO!");
        if (pup.position === "lane1Set") {
          setPup({ ...pup, position: lane1Time.animation, id: "pupMove" });
        }
        if (dan.position === "lane2Set") {
          setDan({ ...dan, position: lane2Time.animation, id: "danMove" });
        }
        if (honey.position === "lane3Set") {
          setHoney({
            ...honey,
            position: lane3Time.animation,
            id: "honeyMove",
          });
        }
        if (golden.position === "lane4Set") {
          setGolden({
            ...golden,
            position: lane4Time.animation,
            id: "goldenMove",
          });
        }
        if (foxy.position === "lane5Set") {
          setFoxy({ ...foxy, position: lane5Time.animation, id: "foxyMove" });
        }
      }, 1300);
  ...
  const handleRematchClick = () => {
    ...
    const allRacerLanes = [
      document.getElementById("setLane1"),
      document.getElementById("setLane2"),
      document.getElementById("setLane3"),
      document.getElementById("setLane4"),
      document.getElementById("setLane5"),
    ];
  ...
  const winResultsCover = (winnerDisplay) => {
    if (winnerDisplay === "on") {
      return (
        <div className="winnerCover" id="winnerCover">
          <h1 className="winnerText" id="winnerText">
            {winTitle()}
          </h1>
          <div className="winContainer" id={winnerEnter}>
            <div
              className={theWinner() + "Shadow"}
              id={theWinnerObj() + "Shadow"}
            ></div>
            <div
              className={the2ndWinner() + "Shadow"}
              id={the2ndWinnerObj() + "Shadow"}
            ></div>
            <div
              className={the3rdWinner() + "Shadow"}
              id={the3rdWinnerObj() + "Shadow"}
            ></div>
          </div>
          <div className="winContainer" id={winnerEnter}>
            <div
            ...
            ></div>
            <div
              className={the2ndWinner()}
              id={the2ndWinnerObj()}
              alt={the2ndWinner()}
            ></div>
            <div
              className={the3rdWinner()}
              id={the3rdWinnerObj()}
              alt={the2ndWinner()}
            ></div>
          </div>
          <h2
            className="winnerSponsor"
            id="winnerSponsor"
            style={{ color: theWinnerColor() }}
          >
            {theWinnerText()}
          </h2>
          <h2
            className="winner2Sponsor"
            id="winner2Sponsor"
            style={{ color: the2ndWinnerColor() }}
          >
            {the2ndWinnerText()}
          </h2>
          <h2
            className="winner3Sponsor"
            id="winner3Sponsor"
            style={{ color: the3rdWinnerColor() }}
          >
            {the3rdWinnerText()}
          </h2>
          <div className="winButtons">
            <div className="reset" id="reset" onClick={handleResetClick}>
              RESTART
            </div>
            <div className="rematch" id="rematch" onClick={handleRematchClick}>
              REMATCH
            </div>
          </div>
        </div>
      ...
      return (
        <div className="winnerCover">
          ...
          <div className="winButtons">
            ...
            |
            <div className="rematch" onClick={handleRematchClick}>
              REMATCH
            </div>
          </div>
        </div>
  ...
  const raceTimeMaker = (racerVariable, racerPradictable) => {
    return Math.random() * racerVariable + racerPradictable;
  };

  const setupRacer = (setLane) => {
    switch (setLane) {
      case "setLane1": {
        setPup({ ...pup, position: "lane1Set", id: "pupMove" });
        ...
        raceTime > 9.3
          ? setLane1Time({ time: raceTime, animation: "lane1Slow" })
          : raceTime < 8.8
      ...
      case "setLane2": {
        setDan({ ...dan, position: "lane2Set", id: "danMove" });
        ...
        // let raceTime = raceTimeMaker(0,9);
        raceTime > 9.3
          ? setLane2Time({ time: raceTime, animation: "lane2Slow" })
          : raceTime > 9
      ...
      case "setLane3": {
        setHoney({ ...honey, position: "lane3Set", id: "honeyMove" });
        ...
        // let raceTime = raceTimeMaker(0,9);
        raceTime > 9.2
          ? setLane3Time({ time: raceTime, animation: "lane3Slow" })
          : raceTime < 8.8
  ...
  useEffect(() => {
    if (pup.id === "pupMove" && go === "START") {
      const moveToClick = setTimeout(
        () => setPup({ ...pup, id: "pupClick" }),
        1700
      );
  ...
  useEffect(() => {
    if (pup.id === "pupClick" && go === "START") {
      const clickToIdle = setTimeout(
        () => setPup({ ...pup, id: "pupIdle" }),
        3600
      );
  ...
  useEffect(() => {
    if (dan.id === "danMove" && go === "START") {
      const moveToClick = setTimeout(
        () => setDan({ ...dan, id: "danClick" }),
        1800
      );
      return () => clearTimeout(moveToClick);
    }
  ...
  useEffect(() => {
    if (dan.id === "danClick" && go === "START") {
      const clickToIdle = setTimeout(
        () => setDan({ ...dan, id: "danIdle" }),
        3700
      );
      return () => clearTimeout(clickToIdle);
    }
  ...
  useEffect(() => {
    if (honey.id === "honeyMove" && go === "START") {
      const moveToClick = setTimeout(
        () => setHoney({ ...honey, id: "honeyClick" }),
        1800
      );
      return () => clearTimeout(moveToClick);
    }
  ...
  useEffect(() => {
    if (honey.id === "honeyClick" && go === "START") {
      const clickToIdle = setTimeout(
        () => setHoney({ ...honey, id: "honeyIdle" }),
        3700
      );
      return () => clearTimeout(clickToIdle);
    }
  ...
  useEffect(() => {
    if (golden.id === "goldenMove" && go === "START") {
      const moveToClick = setTimeout(
        () => setGolden({ ...golden, id: "goldenClick" }),
        1100
      );
      return () => clearTimeout(moveToClick);
    }
  ...
  useEffect(() => {
    if (golden.id === "goldenClick" && go === "START") {
      const clickToIdle = setTimeout(
        () => setGolden({ ...golden, id: "goldenIdle" }),
        3000
      );
      return () => clearTimeout(clickToIdle);
    }
  ...
  useEffect(() => {
    if (foxy.id === "foxyMove" && go === "START") {
      const moveToClick = setTimeout(
        () => setFoxy({ ...foxy, id: "foxyClick" }),
        1500
      );
      return () => clearTimeout(moveToClick);
    }
  ...
  useEffect(() => {
    if (foxy.id === "foxyClick" && go === "START") {
      const clickToIdle = setTimeout(
        () => setFoxy({ ...foxy, id: "foxyIdle" }),
        3000
      );
      return () => clearTimeout(clickToIdle);
    }
  ...
  const setupFocus = (e) => {
    ...
    document.getElementById(htmlfor).checked
      ? document.getElementById(`lane${htmlfor[7]}input`).blur()
      : document.getElementById(`lane${htmlfor[7]}input`).focus();
  };
    ...
    <div className="container" id={follow}>
      <div className="inner-container">
        <div className="grid-container">
          ...
          <div className="go" onClick={handleGo}>
            {go}
          </div>
          ...
          <input
            type="checkbox"
            id="setLane1"
            onClick={(e) => handleSetRacerClick(e)}
          />
          <label
            className="btnLane1"
            htmlFor="setLane1"
            onClick={(e) => setupFocus(e)}
          >
            PUPSTAR
          </label>
          <form
            className="lane1input"
            onSubmit={(e) => handleSubmit(e)}
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                document.getElementById("lane1input").blur();
                racePosition();
              }
            }}
          >
            <input
              ...
              type="text"
              placeholder=""
              onChange={(e) => setPup({ ...pup, sponsor: e.target.value })}
            />
          </form>
          ...
          <form
            className="lane2input"
            onSubmit={(e) => handleSubmit(e)}
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                document.getElementById("lane2input").blur();
                racePosition();
              }
            }}
          >
            <input
              ...
              type="text"
              placeholder=""
              onChange={(e) => setDan({ ...dan, sponsor: e.target.value })}
            />
          </form>
          ...
          <form
            className="lane3input"
            onSubmit={(e) => handleSubmit(e)}
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                document.getElementById("lane3input").blur();
                racePosition();
              }
            }}
          >
            <input
              ...
              type="text"
              placeholder=""
              onChange={(e) => setHoney({ ...honey, sponsor: e.target.value })}
            />
          </form>
          ...
          <form
            className="lane4input"
            onSubmit={(e) => handleSubmit(e)}
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                document.getElementById("lane4input").blur();
                racePosition();
              }
            }}
          >
            <input
              ...
              placeholder=""
              onChange={(e) =>
                setGolden({ ...golden, sponsor: e.target.value })
              }
            />
          </form>
          <div
          ...
          <form
            className="lane5input"
            onSubmit={(e) => handleSubmit(e)}
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                document.getElementById("lane5input").blur();
                racePosition();
              }
            }}
          >
            <input
              ...
              type="text"
              placeholder=""
              onChange={(e) => setFoxy({ ...foxy, sponsor: e.target.value })}
            />
          </form>
          <div className="lane5" id={foxy.position} style={lane5AnimationTime}>
            <div
              className="foxyShadow"
              id={foxy.id + "Shadow"}
              alt={foxy.alt}
            ></div>
          </div>
          <div className="lane5" id={foxy.position} style={lane5AnimationTime}>
            <label htmlFor="setLane5">
